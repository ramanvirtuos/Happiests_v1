              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    <li class="active"><a href="<?php echo base_url();?>messages/index"><i class="fa fa-inbox"></i> Inbox <span class="label label-primary pull-right"><?php echo $count;?></span></a></li>
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-controls">
                    ...
                    <div class="btn-group">
                      ...
                      <button class="btn btn-default btn-sm" id="reply_msg"><i class="fa fa-reply"></i></button>
                  ...
                  <div class="table-responsive mailbox-messages" >
                   ...
                   if(!empty($inbox)){
                      ...
                      ?>
                        <tr>
                          <td><input type="checkbox" name="del_id[]" id="deleteval" value="<?php echo $display_data['id']."_".$display_data['puser_id'];?>"></td>
                          <td class="mailbox-star"><a href="#"><i class="fa fa-star text-yellow"></i></a></td>
                          <td class="mailbox-name"><a href="<?=base_url();?>messages/read/<?php echo $display_data['id'];?>"><?php echo ucwords($display_data['user_name']);?></a></td>
                          <td>
                          <?php 
                          if ($display_data['priority'] == 1){
                              echo '<span class="badge bg-green">Low</span>';
                          }elseif ($display_data['priority'] == 2){
                              echo '<span class="badge bg-light-blue">Normal</span>';
                          }elseif ($display_data['priority'] == 3){
                              echo '<span class="badge bg-yellow">Medium</span>';
                          }elseif ($display_data['priority'] == 4){
                              echo '<span class="badge bg-red">Normal</span>';
                          }
                          ?>
                          </td>
